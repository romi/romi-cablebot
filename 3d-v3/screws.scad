...
kM5LockNutDimensions = [5*mm, 8.79*mm];
...
module M5(length, orientation, extraScrewRadius=0, extraHeadRadius=0, extraHeadHeight=0)
{
    _orient(orientation) {
        _Screw(kM5Dimensions, length, extraScrewRadius, 
                extraHeadRadius,   extraHeadHeight);
    }
}
...
module M5LockNut(orientation, extraRadius=0, extraHeight=0)
{
    _orient(orientation) {
        _LockNut(kM5LockNutDimensions, extraRadius, extraHeight);
    }
}
...
module M5Nut(orientation, extraRadius=0, extraHeight=0)
{
    _orient(orientation) {
        _Nut(kM5NutDimensions, extraRadius, extraHeight);
    }
}
...
module _Countersunk(dimensions, length, extraScrewRadius=0, extraHeadRadius=0, extraHeadHeight=0) 
{
    ...
    union() {
        ...
        translate([0, 0, -length]) 
        cylinder(h=length, 
                r=dimensions[kDiameterScrew] / 2 + extraScrewRadius, 
                $fn=360);
    }
}
